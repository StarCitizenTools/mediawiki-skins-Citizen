...
::: tip Thank you for considering contributing to Citizen!
...
1. 🍴 **Fork** the [Citizen repository](https://github.com/StarCitizenTools/mediawiki-skins-Citizen/fork).
...
Want to see Citizen in your language? You can easily submit translations via [TranslateWiki.net](https://translatewiki.net/w/i.php?title=Special:Translate&group=mwgithub-star-citizen).
